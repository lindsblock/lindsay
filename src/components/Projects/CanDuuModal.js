...
const canDuuModal = ({ handleClose, showing }) => {
  ...
  return(
    <div className={showOrHide}>
      ...
      <p>This was my portfolio project I collaborated on for school. We were each assigned into groups
      ...
      <p>This project was so much fun to work on and we accomplished a lot in a short amount of time.

    ...
    return(
      <div>
        ...
        <Segment style={{
          ...
          <p style={{fontSize:'20px', color:'rgb(99,99,99)'}}>Hey there! My name is Lindsay Block. I am a Full-Stack Web Developer based in SLC, Utah. </p>
          <p style={{fontSize:'20px', color:'rgb(99,99,99)'}}>Need a website? </p>
